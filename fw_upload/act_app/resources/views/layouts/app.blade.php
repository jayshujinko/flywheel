...
<head>
    ...
    <script src="{{ URL::to('tinymce/js/tinymce/tinymce.min.js')}}" referrerpolicy="origin"></script>
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('admin.items.create') }}" >
                                        New Item
                                    </a>
