        ...
        @inject('images', 'App\Image') 
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.pages.update',$article->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row">
                                <label for="main_page" class="col-md-2 col-form-label text-md-right"></label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{$article->title}}" required autocomplete="off" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="sub_title" type="text" class="form-control @error('sub_title') is-invalid @enderror" name="sub_title" value="{{$article->sub_title}}" required autocomplete="off" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-1">
                                    <input id="home_page" 
                                        @if($article->home_page ==1 ) checked @endif 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-1">
                                    <input id="slider" 
                                        @if($article->slider ==1 ) checked @endif 
                             ...
                             <div class="input-group ">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="article_image_01">Upload Article Image</span>
                                </div>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="article_image"
                                    accept="image/jpg, image/png, image/jpeg"
                                    aria-describedby="article_image">
                          ...
                          <div> 
                            ...
                            <div class="form-group row p-3">
                                ...
                                <div class="col-md-12">
                                    <textarea rows="20" class="form-control @error('content') is-invalid @enderror" name="content">
                                        {{$article->content}}
                                    </textarea>
