...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Edit No Image Article {{$article->title}}</div>

                <div class="card-body">
                    
                    <form action="{{route('admin.no-image-articles.update',$article->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <textarea rows="20" class="form-control @error('content') is-invalid @enderror first-content" name="content">
                                                        {{$article->content}}
                                                    </textarea>
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <textarea rows="20" class="form-control @error('second_content') is-invalid @enderror first-content" name="second_content">
